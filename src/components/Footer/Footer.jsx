      ...
      <div className={styles.socialIconsDiv}>
        ...
        <div>
          <a href="https://www.instagram.com/" target="_blank">
            <FontAwesomeIcon
              className={`${styles.socialIcon} ${styles.socialIconFirst}`}
              icon={faInstagram}
            />
          </a>
          <a href="https://es.pinterest.com/" target="_blank">
            <FontAwesomeIcon className={styles.socialIcon} icon={faPinterest} />
          </a>
          ...
          <a href="https://www.whatsapp.com" target="_blank">
            <FontAwesomeIcon className={styles.socialIcon} icon={faWhatsapp} />
          </a>
        </div>
      </div>
